 ...
 *
 */
public class AppSelectActivity extends BaseActivity implements OnItemClickListener, OnItemSelectedListener{
	...
	private Handler mHandler = new Handler(){
		public void handleMessage(Message msg) {
			...
			case SHOW_GRIDVIEW_ITEM:
				...
				my_app_manage_gv.setOnItemSelectedListener(AppSelectActivity.this);
...
*/		
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				case 0:
					if(isVis == REMOVE_FROM_FAV){
						...
						if (getNumberAi() >= 8){
							Toast.makeText(AppSelectActivity.this, "您的常用App已满,请删除后再添加!", Toast.LENGTH_SHORT).show();
						}else{
							//添加到常用
				...
				case 1:
					if(lastFocusPkgName!=null){
						if(checkIsSysApp(lastFocusPkgName)){
							Toast.makeText(AppSelectActivity.this, "系统应用,不能卸载!", Toast.LENGTH_SHORT).show();
							return;
						}else {
	...
	class AppAdapter extends BaseAdapter{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if(convertView == null){
				...
				convertView = View.inflate(AppSelectActivity.this, R.layout.myapp_gridview_item, null);
			...
			//MobclickAgent.onEvent(AppSelectActivity.this, "LOCA_APP_NAME", m_value);
			if(aif.isLove()){
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		//----------------------------
		AppSelectActivity.this.whiteBorder.setVisibility(View.VISIBLE);
		AppSelectActivity mainActivity = AppSelectActivity.this;
		if ((panel_height == 1080) && (panel_width == 1920)){
...
/*		String packname = ((TextView)view.findViewById(R.id.myapp_gridview_item_flag_tv)).getText().toString();
	...
	public void onNothingSelected(AdapterView<?> parent) {
		...
		mIndex = -1;
		isVis = -1;
		AppSelectActivity.this.whiteBorder.setVisibility(View.INVISIBLE);
	}
}
