package com.ktc.tvlauncher.view;
...
/*            		drawable.addFrame(context.getResources().getDrawable(R.drawable.sm_pro6), 200);
            		...
            		drawable.setOneShot(false);//设置为循环播�?            		image.setImageDrawable(drawable);//AnimationDrawable对象给imageView
            		drawable.start();//动画播放
            		msg.setText(message);
                }  
            });  
    ...
    /** 
     *  此处设置亮度值�?dimAmount代表黑暗数量，也就是昏暗的多少，设置�?则代表完全明亮�? 
     *  范围�?.0�?.0 
     */ 
